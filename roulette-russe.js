...
function passGun() {
    ...
    showClickText(() => {
        if (barrel[currentIndex]) {
            ...
            // Affiche une image pour la victoire
            ...
            // Affiche une image pour la réflexion
    ...
    showClickText(() => {
        if (botTarget === "player") {
            ...
            if (barrel[currentIndex]) {
                ...
                // Le bot réfléchit et rejoue après 2 secondes
                setTimeout(botFire, 2000);
            }
        }
        updateScore();
    });
...
// Fonction pour afficher le texte "Clic !" avec un délai
function showClickText(callback) {
    ...
    }, 300); // Attente de 1 seconde avant d'exécuter l'action suivante
}
